...
#define DFP_SELECT_SOURCE             0x09
#define DFP_QUERY_CUR_TF_TRACK        0x4B

#define DFP_DEVICE_TF                 0x02
...
uint8_t DFPLAYER_QueryCurrentTfTrack(DFPLAYER_Name* MP3, uint16_t *track_out, uint32_t timeout_ms);
